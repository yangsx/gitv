	...
	async function loadRepo(path: string) {
		...
		try {
			...
			updateLoadPhaseTimings([
				...
				{ phase: 'arc_topo_sort', durationMs: data.timing.arc_topo_sort_ms },
				{ phase: 'arc_insert', durationMs: data.timing.arc_insert_ms },
				{ phase: 'arc_update_rows', durationMs: data.timing.arc_update_rows_ms },
				{ phase: 'arc_disporder', durationMs: data.timing.arc_disporder_ms },
				{ phase: 'arc_ordertoken', durationMs: data.timing.arc_ordertoken_ms },
				{ phase: 'arc_fix_reversal', durationMs: 0, count: data.timing.arc_fix_reversal_calls },
				{ phase: 'arc_renumber', durationMs: 0, count: data.timing.arc_renumber_arc_calls },
				{ phase: 'arc_split', durationMs: 0, count: data.timing.arc_split_arc_calls },
				{ phase: 'assign_columns', durationMs: data.timing.assign_columns_ms },
				{ phase: 'optimize_rows', durationMs: data.timing.optimize_rows_ms },
				{ phase: 'rebuild_edges', durationMs: data.timing.rebuild_edges_ms },
				{ phase: 'fix_edge_pass', durationMs: data.timing.fix_edge_pass_ms },
				{ phase: 'sibling_walk', durationMs: 0, count: data.timing.sibling_walk_total },
